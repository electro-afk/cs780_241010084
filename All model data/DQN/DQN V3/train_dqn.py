...
LOG_EVERY = 25                 # print stats every N episodes
...
def train(args):
    ...
    for ep in range(1, args.episodes + 1):
        ...
        while not done:
            ...
            clipped_reward = np.clip(reward / 50.0, -4.0, 40.0)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--wall_obstacles", action="store_true", default=False)
